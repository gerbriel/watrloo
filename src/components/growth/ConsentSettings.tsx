...
/**
 * Personalization toggles. Local sponsored placements are contextual and
 * covered by the Terms, so there's no "marketing messages" opt-in here — these
 * only control how much we tailor and measure. Everything defaults OFF (no row
 * = no consent) and each change is written through the stamped set_consent RPC.
 * Copy is honest per docs/growth/COMPLIANCE.md — unbundled, never pre-ticked.
 */
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-app bg-raised">
      <div className="border-b border-app px-4 py-3">
        <h2 className="text-sm font-semibold text-app">Privacy & personalization</h2>
      ...
      <div className="divide-y divide-[var(--border)]">
        <Toggle
          ...
          hint="Lets us note your city (from your network address, never GPS) so nearby sponsored placements are more relevant. The address itself is discarded immediately. Off: you'll still see local placements, just less tailored."
